...
namespace GameAssetBundle
{
    ...
    public static class StringBuilderExtensions
    {
        ...
        {
            return string_builder.ConcatFormat<A, int, int, int, int, int, int>(format_string, arg1, 0, 0, 0, 0, 0, 0);
        }
        ...
        {
            return string_builder.ConcatFormat<A, B, int, int, int, int, int>(format_string, arg1, arg2, 0, 0, 0, 0, 0);
        }
        ...
        {
            return string_builder.ConcatFormat<A, B, C, int, int, int, int>(format_string, arg1, arg2, arg3, 0, 0, 0, 0);
        }
        ...
        {
            return string_builder.ConcatFormat<A, B, C, D, int, int, int>(format_string, arg1, arg2, arg3, arg4, 0, 0, 0);
        }

        public static StringBuilder ConcatFormat<A, B, C, D, E>(this StringBuilder string_builder, String format_string, A arg1, B arg2, C arg3, D arg4, E arg5)
            where A : IConvertible
            where B : IConvertible
            where C : IConvertible
            where D : IConvertible
        ...
        {
            return string_builder.ConcatFormat<A, B, C, D, E, int, int>(format_string, arg1, arg2, arg3, arg4, arg5, 0, 0);
        }

        public static StringBuilder ConcatFormat<A, B, C, D, E, F>(this StringBuilder string_builder, String format_string, A arg1, B arg2, C arg3, D arg4, E arg5, F arg6)
            where A : IConvertible
            where B : IConvertible
            where C : IConvertible
            where D : IConvertible
            where E : IConvertible
            where F : IConvertible
        {
            return string_builder.ConcatFormat<A, B, C, D, E, F, int>(format_string, arg1, arg2, arg3, arg4, arg5, arg6, 0);
        }

        //! Concatenate a formatted string with arguments
        public static StringBuilder ConcatFormat<A, B, C, D, E, F, G>(this StringBuilder string_builder, String format_string, A arg1, B arg2, C arg3, D arg4, E arg5, F arg6, G arg7)
            where A : IConvertible
            where B : IConvertible
            where C : IConvertible
            where D : IConvertible
                ...
                if (format_string[index] == '{')
                {
                    ...
                    else
                    {
                        ...
                        switch (format_char)
                        {
                            ...
                            case '4': string_builder.ConcatFormatValue<E>(arg5, padding, base_value, decimal_places); break;
                            case '5': string_builder.ConcatFormatValue<F>(arg6, padding, base_value, decimal_places); break;
                            case '6': string_builder.ConcatFormatValue<G>(arg7, padding, base_value, decimal_places); break;
    ...
    {
        //初始分配64个单位，最大容纳256个单位
        private static StringBuilder s_StringBuilder = new StringBuilder(512);

        // public static string Format(String format_string, params object[] args)
        // {
        //     int count = args.Length;
        //     switch (count)
        //     {
        //         case 1:
        //             return Format(format_string, args[0]);
        //         case 2:
        //             return Format(format_string, args[0], args[1]);
        //         case 3:
        //             return Format(format_string, args[0], args[1], args[2]);
        //         case 4:
        //             return Format(format_string, args[0], args[1], args[2], args[3]);
        //         case 5:
        //             return Format(format_string, args[0], args[1], args[2], args[3], args[4]);
        //         case 6:
        //             return Format(format_string, args[0], args[1], args[2], args[3], args[4], args[5]);
        //         case 7:
        //             return Format(format_string, args[0], args[1], args[2], args[3], args[4], args[5], args[6]);
        //     }
                ...
                where A : IConvertible
        {
            ...
            return s_StringBuilder.ConcatFormat<A, int, int, int, int, int>(format_string, arg1, 0, 0, 0, 0, 0).ToString();
        }
        ...
        {
            s_StringBuilder.Empty();
            return s_StringBuilder.ConcatFormat<A, B, int, int, int, int>(format_string, arg1, arg2, 0, 0, 0, 0).ToString();
        }
        ...
        {
            s_StringBuilder.Empty();
            return s_StringBuilder.ConcatFormat<A, B, C, int, int, int>(format_string, arg1, arg2, arg3, 0, 0, 0).ToString();
        }
        ...
        {
            s_StringBuilder.Empty();
            return s_StringBuilder.ConcatFormat<A, B, C, D, int, int>(format_string, arg1, arg2, arg3, arg4, 0, 0).ToString();
        }

        public static string Format<A, B, C, D, E>(String format_string, A arg1, B arg2, C arg3, D arg4, E arg5)
            where A : IConvertible
            where B : IConvertible
            where C : IConvertible
            where D : IConvertible
        ...
        {
            s_StringBuilder.Empty();
            return s_StringBuilder.ConcatFormat<A, B, C, D, E, int>(format_string, arg1, arg2, arg3, arg4, arg5, 0).ToString();
        }

        public static string Format<A, B, C, D, E, F>(String format_string, A arg1, B arg2, C arg3, D arg4, E arg5, F arg6)
            where A : IConvertible
            where B : IConvertible
            where C : IConvertible
            where D : IConvertible
        ...
        {
            s_StringBuilder.Empty();
            return s_StringBuilder.ConcatFormat<A, B, C, D, E, F>(format_string, arg1, arg2, arg3, arg4, arg5, arg6).ToString();
        }

        public static string Format<A, B, C, D, E, F, G>(String format_string, A arg1, B arg2, C arg3, D arg4, E arg5, F arg6, G arg7)
            where A : IConvertible
            where B : IConvertible
            where C : IConvertible
            where D : IConvertible
        ...
        {
            s_StringBuilder.Empty();
            return s_StringBuilder.ConcatFormat<A, B, C, D, E, F, G>(format_string, arg1, arg2, arg3, arg4, arg5, arg6, arg7).ToString();
        }
    }
}